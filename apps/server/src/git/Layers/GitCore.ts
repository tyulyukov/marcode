...
import { GitCommandError, type GitBranch } from "@marcode/contracts";
import { dedupeRemoteBranchesWithLocalMatches } from "@marcode/shared/git";
...
import { decodeJsonResult } from "@marcode/shared/schemaJson";
...
> {
  ...
  const traceFilePath = yield* fs.makeTempFileScoped({
    prefix: `marcode-git-trace2-${process.pid}-`,
    suffix: ".json",
  });
