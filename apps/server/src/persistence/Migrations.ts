...
import Migration0023 from "./Migrations/023_ProjectJiraBoard.ts";
import Migration0024 from "./Migrations/024_ProjectionThreadsAdditionalDirectories.ts";
import Migration0025 from "./Migrations/025_ProjectionSnapshotOrderIndexes.ts";
...
export const migrationEntries = [
  ...
  [23, "ProjectJiraBoard", Migration0023],
  [24, "ProjectionThreadsAdditionalDirectories", Migration0024],
  [25, "ProjectionSnapshotOrderIndexes", Migration0025],
] as const;
