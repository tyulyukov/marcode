...
import { type FilesystemBrowseInput, type ProjectEntry } from "@marcode/contracts";
import { isExplicitRelativePath, isWindowsAbsolutePath } from "@marcode/shared/path";
import {
  insertRankedSearchResult,
  normalizeSearchQuery,
  scoreQueryMatch,
  type RankedSearchResult,
} from "@marcode/shared/searchRanking";
