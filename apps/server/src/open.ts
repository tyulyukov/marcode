...
import { EDITORS, OpenError, type EditorId } from "@marcode/contracts";
import { isCommandAvailable, type CommandAvailabilityOptions } from "@marcode/shared/shell";
...
export { OpenError };
export { isCommandAvailable } from "@marcode/shared/shell";
 ...
 */
export class Open extends Context.Service<Open, OpenShape>()("marcode/open") {}
