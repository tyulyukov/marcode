import { EnvironmentId, ProjectId, ThreadId } from "@marcode/contracts";
...
describe("formatWorktreePathForDisplay", () => {
  it("shows only the last path segment for unix-like paths", () => {
    const result = formatWorktreePathForDisplay(
      "/Users/julius/.marcode/worktrees/marcode-mvp/marcode-4e609bb8",
    );
  ...
  it("uses the final segment even when outside ~/.marcode/worktrees", () => {
