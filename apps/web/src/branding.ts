import type { DesktopAppBranding } from "@marcode/contracts";
...
export const APP_BASE_NAME = injectedDesktopAppBranding?.baseName ?? "MarCode";
...
export const SPLASH_LOGO_PATH = "/splash-logo.png";
