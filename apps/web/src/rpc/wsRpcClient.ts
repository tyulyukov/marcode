...
import { applyGitStatusStreamEvent } from "@marcode/shared/git";
...
export interface WsRpcClient {
  ...
  readonly commandOutput: {
    readonly subscribe: RpcStreamMethod<typeof WS_METHODS.subscribeCommandOutput>;
  };
  ...
  readonly jira: {
    ...
    readonly listSites: RpcUnaryNoArgMethod<typeof WS_METHODS.jiraListSites>;
    readonly listBoards: RpcUnaryMethod<typeof WS_METHODS.jiraListBoards>;
    readonly listSprints: RpcUnaryMethod<typeof WS_METHODS.jiraListSprints>;
    readonly listIssues: RpcUnaryMethod<typeof WS_METHODS.jiraListIssues>;
    readonly getIssue: RpcUnaryMethod<typeof WS_METHODS.jiraGetIssue>;
    readonly getAttachment: RpcUnaryMethod<typeof WS_METHODS.jiraGetAttachment>;
    readonly onConnectionStatusChanged: RpcStreamMethod<
      typeof WS_METHODS.subscribeJiraConnectionStatus
    >;
  };
}
...
export function createWsRpcClient(transport: WsTransport): WsRpcClient {
  return {
    ...
    jira: {
      getConnectionStatus: () =>
        transport.request((client) => client[WS_METHODS.jiraGetConnectionStatus]({})),
      disconnect: () => transport.request((client) => client[WS_METHODS.jiraDisconnect]({})),
      listSites: () => transport.request((client) => client[WS_METHODS.jiraListSites]({})),
      listBoards: (input) =>
        transport.request((client) => client[WS_METHODS.jiraListBoards](input)),
      listSprints: (input) =>
        transport.request((client) => client[WS_METHODS.jiraListSprints](input)),
      listIssues: (input) =>
        transport.request((client) => client[WS_METHODS.jiraListIssues](input)),
      getIssue: (input) => transport.request((client) => client[WS_METHODS.jiraGetIssue](input)),
      getAttachment: (input) =>
        transport.request((client) => client[WS_METHODS.jiraGetAttachment](input)),
      onConnectionStatusChanged: (listener, options) =>
        transport.subscribe(
          (client) => client[WS_METHODS.subscribeJiraConnectionStatus]({}),
          listener,
          options,
        ),
    },
