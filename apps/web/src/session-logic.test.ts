...
describe("deriveWorkLogEntries", () => {
  ...
  it("keeps the first lifecycle id stable when a started command later completes", () => {
    const activities: OrchestrationThreadActivity[] = [
      makeActivity({
        id: "cmd-start",
        createdAt: "2026-02-23T00:00:01.000Z",
        ...
        payload: {
          ...
          detail: "bun test",
          data: { input: { command: "bun test" }, status: "inProgress" },
        },
      }),
      makeActivity({
        id: "cmd-complete",
        ...
        payload: {
          ...
          detail: "ok",
          data: { input: { command: "bun test" }, exitCode: 0, status: "completed" },
        },
      }),
    ];
