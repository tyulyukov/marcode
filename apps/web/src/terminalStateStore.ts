...
import { parseScopedThreadKey, scopedThreadKey } from "@marcode/client-runtime";
import { type ScopedThreadRef, type TerminalEvent } from "@marcode/contracts";
...
const TERMINAL_STATE_STORAGE_KEY = "marcode:terminal-state:v1";
