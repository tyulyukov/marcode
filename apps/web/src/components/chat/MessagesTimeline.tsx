...
import { deriveTimelineEntries, formatElapsed, type AgentGroup } from "../../session-logic";
import { AgentTaskRow } from "./AgentTaskDisplay";
        ...
        <div className="py-0.5 pl-1.5">
          <div className="flex items-center gap-2 pt-1 text-[11px] text-muted-foreground/70">
            <span className="inline-flex items-center gap-[3px]">
              ...
              <span className="h-1 w-1 rounded-full bg-primary/40 animate-pulse [animation-delay:200ms]" />
              <span className="h-1 w-1 rounded-full bg-primary/40 animate-pulse [animation-delay:400ms]" />
            </span>
            <span>
              {isSendBusy ? (
                "Starting\u2026"
