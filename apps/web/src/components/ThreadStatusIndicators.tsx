import { scopeProjectRef, scopedThreadKey, scopeThreadRef } from "@marcode/client-runtime";
import type { GitStatusResult } from "@marcode/contracts";
...
export type GitHostProvider = NonNullable<GitStatusResult["gitHostProvider"]>;

export interface PrStatusIndicatorInput {
  pr: ThreadPr;
  gitHostProvider: GitHostProvider | undefined;
}

export function prStatusIndicator(input: PrStatusIndicatorInput): PrStatusIndicator | null {
...
export function ThreadRowLeadingStatus({ thread }: { thread: SidebarThreadSummary }) {
  ...
  const prStatus = prStatusIndicator({
    pr,
    gitHostProvider: gitStatus.data?.gitHostProvider ?? undefined,
  });
